...
export interface GreeterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addGreet" | "getGreetCount" | "getGreets" | "sendEther" | "withdrawGreet"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "sendEther", values: [PromiseOrValue<string>]): string;
...
export interface Greeter extends BaseContract {
    ...
    functions: {
        ...
        sendEther(_to: PromiseOrValue<string>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getGreetCount(person: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        getGreets(person: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        sendEther(_to: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
